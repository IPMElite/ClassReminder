...
async def on_ready():
	try:
		...
		await bot.create_channel(guild, "reminder", type=discord.ChannelType.text)
		message = await bot.send_message(discord.utils.get(guild.channels, name = "reminders"), "This is an automatic message per launch and will be deleted after a few seconds.")
